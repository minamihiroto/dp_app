...
@section('content')
<section class="cansel-page">
  <h1 class="cansel-page-title">規約等の確認</h1>
  <section class="agreement">
    <h1>利用規約</h1>
    <br>
    <br>
    <br>
    <p>この利用規約（以下，「本規約」といいます。）は，dearpilates（以下，「当社」といいます。）がこのウェブサイト上で提供するオンラインレッスン（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
    <br>
    <h2>第1条（適用）</h2>
    ...
    <p>2.当社は，利用登録の申請者に以下の事由があると判断した場合，利用登録の申請を承認しないことがあり，その理由については一切の開示義務を負わないものとします。
      <p>・1.利用登録の申請に際して虚偽の事項を届け出た場合</p>
      <p>・2.本規約に違反したことがある者からの申請である場合</p>
      <p>・3.その他，当社が利用登録を相当でないと判断した場合</p>
    <br>
    <h2>第3条（パスワードの管理）<h2>
    <p>1.ユーザーは，自己の責任において，本サービスのパスワードを適切に管理するものとします。<p>
    <p>2.ユーザーは，いかなる場合にも，パスワードを第三者に譲渡または貸与し，もしくは第三者と共用することはできません。当社は，メールアドレスとパスワードの組み合わせが登録情報と一致してログインされた場合には，そのメールアドレスを登録しているユーザー自身による利用とみなします。</p>
    <p>3.パスワードが第三者によって使用されたことによって生じた損害は，当社に故意又は重大な過失がある場合を除き，当社は一切の責任を負わないものとします。</p>
    <br>
    ...
    <p>1.当社は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，ユーザーに対して，本サービスの全部もしくは一部の利用を制限し，またはユーザーとしての登録を抹消することができるものとします。</p>
      ...
      <p>・4.当社からの連絡に対し，一定期間返答がない場合</p>
      <p>・5.本サービスについて，最終の利用から一定期間利用がない場合</p>
      <p>・6.その他，当社が本サービスの利用を適当でないと判断した場合</p>
  ...
  <section class="privacy">
    ...
    <br>
    <br>
    <p>dearpilates（以下，「当社」といいます。）は，本ウェブサイト上で提供するオンラインレッスン（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
    <br>
    <h2>第1条（個人情報）</h2>
    ...
    <p>1.当社は，次に掲げる場合を除いて，あらかじめユーザーの同意を得ることなく，第三者に個人情報を提供することはありません。ただし，個人情報保護法その他の法令で認められる場合を除きます。</p>
      ...
      <p>・3.国の機関もしくは地方公共団体またはその委託を受けた者が法令の定める事務を遂行することに対して協力する必要がある場合であって，同意を得ることにより当該事務の遂行に支障を及ぼすおそれがあるとき</p>
    ...
    <br>
    <h2>第10条（お問い合わせ窓口）</h2>
    <p>本ポリシーに関するお問い合わせは，dearpilates.yukinco☆gmail.comまでお願いします。</p>
    <p>※迷惑メール対策のため、「☆」で表記しております。お問合わせの際は「☆」を半角の「@」に変更してご利用ください。</p>
    <br>
    <br>
    <br>
    <br>
  ...
  <p style="color: red;">日割計算ではないので退会時残り日数があっても返金は行えません。</p>
    ...
    @if(Auth::user()!=null)
        ...
        @else
        <form name="delete_user" method="POST" action="/delete/{{$user->id}}" style="margin-bottom: 50px">
            @csrf
            <a href="javascript:void(0)" onclick="this.parentNode.submit()">即時に退会する</a>
        </form>
        @endif
    @endif
</section>
